...
export const SignUp = async (
 req, res
  ...
  const { password, email, name, last_name, company_name, country, office_country, cell_phone, occupation } = req.body;
  ...
  try {
    ...
    if (!verifyEmail) {
      const createUser = new userModel({
          name, last_name,company_name, country, office_country, cell_phone, occupation,
          email: email,
        password: hash,
      });
