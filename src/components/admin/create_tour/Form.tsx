...
import BookingReports from "../supplier/GridLists/BookingReports";
import RevenueReports from "../supplier/GridLists/RevenueReports";
import SupplierReports from "../supplier/GridLists/SupplierReports";
import CustomerBehavior from "../supplier/GridLists/CustomerBehavior";
...
function DataGridTabs({ title }: { title: string }) {
  ...
  const TabsData = [
    { title: "Create Tour", Component: <CreateTourForm /> },
    { title: "Tours", Component: <RevenueReports /> },
