...
import { Cover } from '@/src/utils/images/images'
  ...
  return (
    <>
      <Client_Hero 
        ...
        subTitle={'Embark on a journey to unforgettable destinations, where breathtaking landscapes meet vibrant cultures. Your adventure of a lifetime starts right here!'} />
