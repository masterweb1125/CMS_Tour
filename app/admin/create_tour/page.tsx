...
function CreateTourAdminSide() {
  ...
  return (
    <div>
      ...
      <QuickTabs url={'/admin/create_tour/tour/'} />
        ...
        <Grid container mt={3} spacing={3}>
          {tours.length !== 0 && tours.map((tour) => (
            <Grid item xs={12} md={4} key={tour._id}>
              <TourCardView userUrl={'/admin/create_tour/tour/'} tour={tour} user={user} />
            </Grid>
          ))}
        </Grid>
...
export default CreateTourAdminSide;
